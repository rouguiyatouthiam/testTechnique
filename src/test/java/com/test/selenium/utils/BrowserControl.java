...
public class BrowserControl {
	 ...
	 * @param time
	 */
	public void impliciteTime(long time)
	{
	 ...
	 * @param time
	 */
	public void waitTimeForVisibilityAndelementToBeClickable(long time,WebElement element)
	{
		 t = new WebDriverWait(this.getDriver(), time); 
		 
		 
		// t.until(ExpectedConditions.invisibilityOfElementLocated(element));  
